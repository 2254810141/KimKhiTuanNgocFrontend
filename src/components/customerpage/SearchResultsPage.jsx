    ...
    <section className="container-app space-y-5">
      <div className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm sm:p-5">
        <div>
          ...
          <h2 className="mt-2 text-xl font-black text-zinc-900 sm:text-2xl">Kết quả tìm kiếm</h2>
      ...
      {!isLoading && !error && products.length > 0 && (
        <>
          ...
          {products.length > PAGE_SIZE && (
            <div className="flex flex-col items-stretch justify-center gap-2 sm:flex-row sm:items-center sm:gap-3" role="navigation" aria-label="Phân trang kết quả">
              <button
                type="button"
              ...
              <span className="text-center text-sm font-semibold text-zinc-600 sm:flex-1">
